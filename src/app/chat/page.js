...
export default function ChatPage() {
  ...
  switch (languageMode) {
    case "ayutthaya":
      welcomeMessage = `ไหว้สาเจ้าค่ะ! 🌟 แม่หญิงไอจังพร้อมเป็นแม่สื่อพาเที่ยว **${selectedProvince}** ให้ท่านพี่แล้วหนา!\n\nเพื่อให้การเดินทางราบรื่นไร้กังวล รบกวนบอกกล่าวรายละเอียดสักนิดเถิดเจ้าค่ะ:\n\n1. 🗓️ **ไปกี่เพลา กี่ราตรี?** (เช่น 3 วัน 2 คืน)\n2. 👥 **ไปกับผู้ใดบ้าง?** (เช่น ลุยเดี่ยว, สวีทกับคู่หมาย, หรือครอบครัว)\n3. 🚗 **เดินทางด้วยพาหนะใด?** (เช่น นั่งรถม้า, ขับรถไปเอง)\n4. 🛌 **ปรารถนาที่พำนักเยี่ยงไร?** (เช่น เรือนหอ, เรือนแพ, หรือกางเต็นท์)\n5. 💰 **อัฐ (งบประมาณ) มีสักเท่าใด?** (บอกงบรวม ไอจังจะช่วยประหยัดเบี้ยให้!)\n6. 🎒 **สไตล์เที่ยว / รีเควสพิเศษ:** (เช่น เน้นไหว้พระ, ลุยป่า, หรือของกิน)\n\nบอกกล่าวมาได้เลยเจ้าค่ะ เดี๋ยวไอจังเสกแพลนให้ทันที! 🚀✨`;
      break;
    case "sukhothai":
      welcomeMessage = `เจริญพร! 🌟 ข้ากุฏุมพีไอจัง พร้อมนำทางสู่นคร **${selectedProvince}** แล้วหนา!\n\nเพื่อจัดแจงการเดินทางให้สุนทรีย์ จงบอกกล่าวรายละเอียดมาตามนี้เถิด:\n\n1. 🗓️ **พำนักกี่เพลา?** (เช่น 3 วัน 2 คืน)\n2. 👥 **มีผู้ร่วมทางกี่คน?**\n3. 🚗 **สัญจรด้วยสิ่งใด?**\n4. 🛌 **ต้องการเรือนพักแบบใด?**\n5. 💰 **มีเบี้ยอัฐเท่าใด?**\n6. 🎒 **ประสงค์สิ่งใดเป็นพิเศษ?**\n\nบอกกล่าวข้ามาเถิด ข้าจะรจนาแผนการเดินทางให้งดงามดั่งจารึก! 🚀✨`;
      break;
    case "palace":
      welcomeMessage = `สวัสดีเพคะ! 🌟 หม่อมฉันไอจัง พร้อมถวายงานจัดทริป **${selectedProvince}** แล้วเพคะ!\n\nเพื่อให้แผนการเดินทางสมบูรณ์แบบที่สุด ขอประทานอนุญาตทราบรายละเอียดดังนี้เพคะ:\n\n1. 🗓️ **เสด็จกี่วัน กี่คืนเพคะ?**\n2. 👥 **มีผู้ติดตามกี่ท่านเพคะ?**\n3. 🚗 **เดินทางด้วยพาหนะใดเพคะ?**\n4. 🛌 **โปรดที่ประทับแบบใดเพคะ?**\n5. 💰 **งบประมาณส่วนพระองค์?**\n6. 🎒 **พระประสงค์พิเศษ?** (เช่น เสวยพระกระยาหารร้านดัง, ไหว้พระ)\n\nรับสั่งมาได้เลยเพคะ หม่อมฉันจะจัดการถวายให้ครบถ้วนทุกประการ! 🌸✨`;
      break;
    case "local":
      welcomeMessage = `สวัสดีจ้าว/เด้อ/นิ! 🌟 ไอจังพร้อมพาเที่ยว **${selectedProvince}** แบบโลคอลถึงถิ่นแล้ว!\n\nเพื่อให้ทริปนี้ม่วนซื่นและคุ้มค่าสุดๆ รบกวนบอกรายละเอียดนิดนึงน้า:\n\n1. 🗓️ **ไปกี่วัน กี่คืน?** (เช่น 3 วัน 2 คืน)\n2. 👥 **ไปกับใครบ้าง?** (เพื่อน, แฟน, ครอบครัว)\n3. 🚗 **เดินทางยังไง?** (ขับรถไปเอง, เช่ารถ)\n4. 🛌 **สไตล์ที่พักที่ชอบ?** (โรงแรม, โฮมสเตย์)\n5. 💰 **งบประมาณ:** (บอกงบรวมมาได้เลย เดี๋ยวช่วยคุม!)\n6. 🎒 **สไตล์เที่ยว / รีเควสพิเศษ:** (เน้นกิน, สายมู, หรืออยากไปไหนเป็นพิเศษ)\n\nพิมพ์บอกมาได้เลยเด้อ เดี๋ยวไอจังจัดแพลนเที่ยวให้แบบม่วนๆ เลย! 🚀✨`;
      break;
    default:
      welcomeMessage = `สวัสดีค่าาา! 🌟 ไอจังพร้อมเป็นไกด์ส่วนตัวจัดทริปสุดฟินที่ **${selectedProvince}** ให้นายท่านแล้วค่ะ!\n\nเพื่อให้ไอจังจัดตารางเที่ยวได้เป๊ะปัง คุมงบอยู่ และโดนใจที่สุด รบกวนกระซิบบอกรายละเอียดไอจังตามนี้หน่อยน้า:\n\n1. 🗓️ **ไปกี่วัน กี่คืน?** (เช่น 3 วัน 2 คืน หรือไปเช้าเย็นกลับ)\n2. 👥 **ไปกับใครบ้าง?** (เช่น ลุยเดี่ยว, สวีทกับแฟน 2 คน, แก๊งเพื่อน, หรือครอบครัวมีเด็ก/ผู้สูงอายุ)\n3. 🚗 **เดินทางยังไงคะ?** (เช่น ขับรถไปเอง, นั่งเครื่องไปเช่ารถ, หรือนั่งรถไฟ/รถตู้)\n4. 🛌 **สไตล์ที่พักที่ชอบ?** (เช่น โรงแรม 5 ดาว, พูลวิลล่า, โฮสเทลประหยัดงบ, หรือกางเต็นท์)\n5. 💰 **งบประมาณ:** (บอกงบรวมทั้งหมด หรืองบต่อคนก็ได้ค่ะ ไอจังจะช่วยคุมให้ไม่บานปลาย!)\n6. 🎒 **สไตล์เที่ยว / รีเควสพิเศษ:** (เช่น เน้นคาเฟ่ถ่ายรูป, สายมูไหว้พระ, ลุยธรรมชาติ, หรือมี "ร้าน/สถานที่" ที่บังคับว่าต้องไปให้ได้ บอกมาได้เลยค่ะ)\n\nก๊อปปี้หัวข้อไปตอบ หรือจะพิมพ์เล่าให้ไอจังฟังแบบสบายๆ ก็ได้นะคะ เดี๋ยวไอจังเสกแพลนเที่ยวพร้อมคำนวณค่าใช้จ่ายให้แบบจัดเต็มเลยย! 🚀✨`;
  }
